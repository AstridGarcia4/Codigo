...
button4 = ctk.CTkButton(header, text="Ventas con ticket", fg_color="#003274", text_color="white", hover_color="#0f1f7a", width=80, height=30)
button4.place(x=360, y=10)
...
# botón amarillo a un lado del campo de búsqueda
...
yellow_button.place(x=690, y=10)
